...
Vagrant.configure("2") do |config|
   ...
   config.vm.define "dhcp_server" do |dhcp_server|
    dhcp_server.vm.network "public_network", bridge: "em1", ip: "192.168.140.2", netmask: "255.255.255.0"
   ...
   config.vm.define "ci_server" do |ci_server|
    ci_server.vm.network "public_network", bridge: "em1", ip: "192.168.140.4", netmask: "255.255.255.0"
